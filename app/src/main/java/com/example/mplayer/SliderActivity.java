...
import com.example.mplayer.databinding.ActivitySliderBinding;
...
public class SliderActivity extends AppCompatActivity {
    ...
    void setSliderDrawer() {
        setSupportActionBar(binding.appBarSlider.toolbar);
//        binding.appBarSlider.ducks.setOnClickListener(v -> {
...
//        });
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_playlists)
